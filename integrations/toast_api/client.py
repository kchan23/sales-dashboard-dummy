...
class ToastAPIClient:
    ...
    def __init__(self, credentials_path: Optional[str] = None):
        ...
        if not cred_file.exists():
            raise FileNotFoundError(
                ...
                "Copy toast_credentials.template.json to toast_credentials.json "
    ...
    def authenticate(self):
        """Explicitly authenticate and obtain a token."""
        self._authenticate()
    ...
    def discover_restaurants(self) -> List[Dict]:
        ...
        """
        resp = self.get(RESTAURANTS_ENDPOINT, require_restaurant=False)
